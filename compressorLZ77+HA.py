...
for input_file in input_files:
    ...
    print(input_file)
    run_lz77("compress", path_to_input_file, path_to_semicompressed_file, 16384, 128)
    ...
    run_lz77("decompress", path_to_semidecompressed_file, path_to_output_file, 16384, 128)
    write_table("tables/lz77+ha.csv", collect_information("LZ77 + HA", input_file, path_to_input_file, path_to_compressed_file, path_to_output_file))
    print("-----------")