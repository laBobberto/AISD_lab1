...
for input_file in input_files:
    ...
    print(input_file)
    run_lz78("compress", path_to_input_file, path_to_compressed_file)

    run_lz78("decompress", path_to_compressed_file, path_to_output_file)
    write_table("tables/lz78.csv", collect_information("LZ78", input_file, path_to_input_file, path_to_compressed_file, path_to_output_file))
    print("-----------")